...
public class DisjointSetTest {
    ...
    public void testNumComponents() {
        ...
        DisjointSet uf = new DisjointSetWithArray(5);
    ...
    public void testConnectivity() {
        ...
        int sz = 7;
        DisjointSet uf = new DisjointSetWithArray(sz);
    ...
    public void testBadDisjointSetCreation1() {
        new DisjointSetWithArray(-1);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testBadDisjointSetCreation2() {
        new DisjointSetWithArray(-3463);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testBadDisjointSetCreation3() {
        new DisjointSetWithArray(0);
    }
